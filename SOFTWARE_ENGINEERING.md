...
| BR-10 | Relevant autocomplete/prediction (*competitive* at MVP; beating iOS prediction quality is a v1.x goal via the neural LM — ADR-3) | `prediction`, `dictionary`, `featherkey-neural-lm` | prediction-quality eval | MVP |
| BR-11 | Prediction improves with use | `prediction`, `personalization`, `neural-runtime`, `featherkey-neural-lm` | longitudinal eval | v1.x |
