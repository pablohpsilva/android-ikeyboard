...
> **ADR status:** ADR-1/2/3 and **ADR-12–18** are **ratified** (sponsor-approved). ADR-4–11 are **proposed defaults** — recorded here with rationale for engineering review; each can be revisited with data before implementation locks it in.
